                ...
                <ul className="list-unstyled ps-0">
                    <li className="mb-1">
                        <Link tag="a" className="" to="/">
                            <i className="fa fa-globe"></i> Resumen Global
                        </Link>
                    </li>                   
                    <li className="border-top my-3"></li>
                    <li className="mb-1">
                        <Link tag="a" className="" to="/totalCountrys">
                        <i className="fa fa-thermometer-full" aria-hidden="true"></i> Total por paises
                        </Link>
                    </li>
